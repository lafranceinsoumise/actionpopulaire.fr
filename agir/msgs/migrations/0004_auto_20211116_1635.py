# Generated by Django 3.1.13 on 2021-11-16 15:35
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name="SupportGroupMessageOrganization",
            fields=[
                (
                    "created",
        ...
        migrations.CreateModel(
            name="SupportGroupMessageOrganizationComment",
            fields=[
                (
                    "created",
                    models.DateTimeField(
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="msgs.supportgroupmessageorganization",
                        verbose_name="Message initial",
                    ),
                ),
            ],
            options={
                "verbose_name": "Commentaires de messages privés avec les animateur·ices de groupe",
            },
        ),
        migrations.AddConstraint(
            model_name="supportgroupmessageorganization",
