    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', models.ImageField(blank=True, help_text="L'icône associée aux marqueurs sur la carte.", upload_to=lib_models.UploadToInstanceDirectoryWithFilename(filename='icon'), verbose_name='icon')),
