...
urlpatterns = [
    ...
    path('groupes/<uuid:pk>/localisation/', views.ChangeGroupLocationView.as_view(),
        name='change_group_location'),
    path('groupes/retirer_gestionnaire/<int:pk>/', views.RemoveManagerView.as_view(),
        name='remove_manager'),

    path('livrets_thematiques/', views.ThematicBookletViews.as_view(), name="thematic_groups_list"),
]
