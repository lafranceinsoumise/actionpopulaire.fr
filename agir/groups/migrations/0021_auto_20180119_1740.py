...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='supportgroupsubtype',
            name='popup_anchor_x',
            field=models.PositiveSmallIntegerField(blank=True, null=True, verbose_name='ancre de la popup (x)'),
        ),
        migrations.AlterField(
            model_name='supportgroupsubtype',
            name='popup_anchor_y',
            field=models.PositiveSmallIntegerField(blank=True, null=True, verbose_name='ancre de la popup (y)'),
        ),
    ]
