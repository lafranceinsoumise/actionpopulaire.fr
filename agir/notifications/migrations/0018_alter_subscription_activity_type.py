# Generated by Django 3.2.12 on 2022-03-02 17:00
...
def add_group_attendee_subscriptions(apps, schema_editor):
    ...
    subscriptions = [
        Subscription(
            type=SUBSCRIPTION_PUSH,
            activity_type=TYPE_GROUP_JOIN_EVENT,
...
def remove_group_attendee_subscriptions(apps, schema_editor):
    ...
    Subscription.objects.filter(
        type=SUBSCRIPTION_PUSH,
        activity_type__in=[TYPE_NEW_GROUP_ATTENDEE, TYPE_GROUP_JOIN_EVENT],
    ).delete()
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[
                    ...
                    ("group-join-event", "Le groupe participe à un événement"),
