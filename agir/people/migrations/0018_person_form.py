...
class Migration(migrations.Migration):
    ...
    dependencies = [("people", "0017_help_text_on_location_address")]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.TextField(
                        help_text="Description visible sur la page au remplissage du formulaire",
                ...
                (
                    ...
                    django.contrib.postgres.fields.ArrayField(
                        ...
                        blank=True,
                        default=list,
                        help_text="Une liste de champs de personnes à demander aux personnes qui remplissent le formulaire.",
                        size=None,
                        verbose_name="Informations personnelles requises",
                    ),
                ),
                (
                    "additional_fields",
                    django.contrib.postgres.fields.jsonb.JSONField(
                        default=list, verbose_name="Champs additionnels", blank=True
                    ),
                ),
                (
                    "tags",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "data",
                    django.contrib.postgres.fields.jsonb.JSONField(
                        editable=False, verbose_name="Données"
                    ),
                ),
                (
                    "form",
        ...
        migrations.AlterModelOptions(
            name="personemail", options={"verbose_name": "Email"}
        ),
    ]
