...
const fullCountryList = countriesFirst.map((code) => ({code, label: countries[code], key: `${code}1`})).concat(
  Object.keys(countries).map((code) => ({code, label: countries[code], key: `${code}2`})).sort(
...
const requiredFields = ['locationName', 'locationAddress1', 'locationCity', 'locationCountryCode'];
  ...
  render() {
    ...
    return (
      <div className="row padtopmore">
        ...
        <div className="col-md-6">
          <div className={'form-group' + (this.hasError('locationName') ? ' has-error' : '')}>
          ...
          <div className={'form-group' + (this.hasError('locationAddress1') ? ' has-error' : '')}>
          ...
          <div className="row">
            <div className="col-md-4">
              <div className={'form-group' + (this.hasError('locationZip') ? ' has-error' : '')}>
            ...
            <div className="col-md-8">
              <div className={'form-group' + (this.hasError('locationCity') ? ' has-error' : '')}>
          ...
          <div className={'form-group' + (this.hasError('locationCountryCode') ? ' has-error' : '')}>
