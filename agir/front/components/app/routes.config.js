...
export const routeConfig = {
  ...
  replyToSingleVotingProxyRequest: new RouteConfig({
    id: "replyToSingleVotingProxyRequest",
    path: "/procuration/prendre-une-procuration/demande/:votingProxyRequestPk/",
    params: { votingProxyRequestPk: null },
    exact: true,
    neededAuthentication: AUTHENTICATION.NONE,
    label: "Prendre une procuration de vote",
    Component: RouteComponents.ReplyToSingleVotingProxyRequest,
    hasLayout: false,
    hideFeedbackButton: true,
    hideFooter: true,
    appOnlyTopBar: true,
  ...
  votingProxyRequestsForProxy: new RouteConfig({
    id: "votingProxyRequestsForProxy",
    path: "/procuration/prendre-une-procuration/:votingProxyPk/demandes/",
    params: { votingProxyPk: null },
    exact: true,
    neededAuthentication: AUTHENTICATION.NONE,
    label: "Prendre une procuration de vote",
    Component: RouteComponents.VotingProxyRequestForProxy,
    hasLayout: false,
    hideFeedbackButton: true,
    hideFooter: true,
    appOnlyTopBar: true,
