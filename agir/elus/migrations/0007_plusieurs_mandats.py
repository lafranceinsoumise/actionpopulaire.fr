    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=django.contrib.postgres.fields.ranges.DateRangeField(
                default=agir.elus.models.mandat_departemental_dates_par_defaut,
        ...
        migrations.AddField(
            ...
            name="dates",
            field=django.contrib.postgres.fields.ranges.DateRangeField(
                default=agir.elus.models.mandat_municipal_dates_par_defaut,
                help_text="La date de fin correspond à la date théorique de fin du mandat si elle est dans le futur et à la date effective sinon.",
                verbose_name="Début et fin du mandat",
            ),
        ),
        migrations.AddField(
            ...
            name="dates",
            field=django.contrib.postgres.fields.ranges.DateRangeField(
                default=agir.elus.models.mandat_regional_dates_par_defaut,
                help_text="La date de fin correspond à la date théorique de fin du mandat si elle est dans le futur et à la date effective sinon.",
                verbose_name="Début et fin du mandat",
            ),
        ),
