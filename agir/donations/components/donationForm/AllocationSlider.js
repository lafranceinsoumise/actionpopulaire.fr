      ...
      <div style={{ overflow: "hidden" }}>
        ...
        <Flex>
          ...
          <ValueBlock right>
            <div>
              <Amount>
                {allocation === "" ? "--,-- €" : displayPrice(allocation)}
              </Amount>
            </div>
            Activités du groupe
            <div>
              {groupName && (
                <React.Fragment>
                  &laquo;&nbsp;<strong>{groupName}</strong>&nbsp;&raquo;
                </React.Fragment>
              )}
            </div>
          </ValueBlock>
...
AllocationSlider.propTypes = {
  ...
  nationalRatio: PropTypes.number,
