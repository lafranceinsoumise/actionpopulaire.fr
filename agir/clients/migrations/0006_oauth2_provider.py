...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='client',
            name='user',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='clients_client', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AlterField(
            model_name='client',
            name='label',
            field=models.CharField(help_text="L'identifiant du client, utilisé pour l'authentication.", max_length=40,
                                   verbose_name='identifiant du client', blank=True)
        ),
    ]
