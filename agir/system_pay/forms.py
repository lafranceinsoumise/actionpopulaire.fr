...
class SystempayRedirectForm(forms.Form):
    ...
    vads_url_cancel = fields.CharField(initial=front_url_lazy('system_pay:return', query={'status': 'cancel'}), widget=forms.HiddenInput())
    vads_url_error = fields.CharField(initial=front_url_lazy('system_pay:return', query={'status': 'error'}), widget=forms.HiddenInput())
    vads_url_refused = fields.CharField(initial=front_url_lazy('system_pay:return', query={'status': 'refused'}), widget=forms.HiddenInput())
    vads_url_success = fields.CharField(initial=front_url_lazy('system_pay:return', query={'status': 'success'}), widget=forms.HiddenInput())
