...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='supportgroupsubtype',
            name='icon',
            field=models.ImageField(blank=True, help_text="L'icône associée aux marqueurs sur la carte.", upload_to=lib.models.UploadToInstanceDirectoryWithFilename(filename='icon'), verbose_name='icon'),
        ),
    ]
