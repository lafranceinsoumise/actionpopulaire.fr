    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', stdimage.models.StdImageField(help_text="L'icône associée aux marqueurs sur la carte.", upload_to=lib.models.UploadToInstanceDirectoryWithFilename(filename='icon'), verbose_name='icon')),
