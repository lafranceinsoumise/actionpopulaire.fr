...
from groups.models import SupportGroup as SupportGroupClass
...
def create_basic_subtypes(apps, schema_editor):
    ...
    subtypes = [
        ...
        },
        {
            ...
            'description': 'Groupe de rédaction du livret. Il y en a un par livret',
...
class Migration(migrations.Migration):
    dependencies = [
        ('groups', '0017_auto_20171214_1306'),
    ]
