# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2017-06-23 11:14
...
def add_basic_tags(apps, schema):
    ...
    for tag, description in info_tags:
        PersonTag.objects.update_or_create(label="info %s" % tag, defaults={"description": description})

    for tag, short_description, long_description in agir_tags:
        description = "**%s**\n\n*%s*" % (short_description, long_description)
        PersonTag.objects.update_or_create(label="agir %s" % tag, defaults={"description": description})


class Migration(migrations.Migration):

    dependencies = [
        ('people', '0002_auto_20170615_0849'),
    ]
