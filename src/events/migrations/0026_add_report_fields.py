...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='event',
            name='report_content',
            field=lib.models.DescriptionField(blank=True, help_text="Ajoutez un compte-rendu de votre événement. N'hésitez pas à inclure des photos.", verbose_name="compte-rendu de l'événement"),
        ),
        migrations.AddField(
            model_name='event',
            name='report_image',
