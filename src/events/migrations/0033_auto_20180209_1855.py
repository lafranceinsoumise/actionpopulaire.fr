...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='event',
            name='subtype',
            field=models.ForeignKey(default=events.models.get_default_subtype, on_delete=django.db.models.deletion.PROTECT, related_name='events', to='events.EventSubtype'),
        ),
        migrations.AlterField(
            model_name='eventsubtype',
            name='color',
