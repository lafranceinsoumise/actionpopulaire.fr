...
from events.views import notification_listener as event_notification_listener
...
class EventPagesTestCase(TestCase):
    ...
    @mock.patch("events.forms.send_event_changed_notification")
    ...
    @mock.patch('events.views.send_rsvp_notification')
