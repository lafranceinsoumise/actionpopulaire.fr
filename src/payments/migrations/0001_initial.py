    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location_address', models.CharField(blank=True, help_text="L'adresse telle qu'elle a éventuellement été copiée depuis NationBuilder. Ne plus utiliser.", max_length=255, verbose_name='adresse complète')),
                ('email', models.EmailField(max_length=255, verbose_name='email')),
                ('first_name', models.CharField(max_length=255, verbose_name='prénom')),
                ('last_name', models.CharField(max_length=255, verbose_name='nom de famille')),
                ('type', models.CharField(choices=[('don', 'don'), ('inscription à un événement', 'événement')], max_length=255, verbose_name='type')),
                ('price', models.IntegerField(verbose_name="prix en centimes d'euros")),
                ('status', models.IntegerField(choices=[(0, 'En attente'), (1, 'Terminé'), (2, 'Abandonné'), (3, 'Annulé'), (4, 'Refusé')], default=0, verbose_name='status')),
                ('meta', django.contrib.postgres.fields.jsonb.JSONField(blank=True, default=dict)),
                ('systempay_responses', django.contrib.postgres.fields.jsonb.JSONField(blank=True, default=list)),
