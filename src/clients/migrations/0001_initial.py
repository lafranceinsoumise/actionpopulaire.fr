    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('verbose_name', models.CharField(help_text="Le nom du client, tel qu'affiché à l'utilisateur lorsqu'il autorise ce client.", max_length=150, verbose_name='nom du client')),
                ...
                ('uris', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=150), default=list, help_text="La liste des URIs auxquelles le serveur d'authentification acceptera de rediriger les utilisateurs pendant la procédure OAuth.", size=4, verbose_name='URIs de redirection OAuth')),
